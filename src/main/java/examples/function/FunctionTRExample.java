...
public class FunctionTRExample {
    ...
    private static void runComposeExample()
    {
        // Employee is input
        // String is output
        Function<Employee, String> functionEmpToString = (Employee e) -> {return e.getName();};
